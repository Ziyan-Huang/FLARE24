...
def convert_predicted_logits_to_segmentation_with_correct_shape(predicted_logits: Union[torch.Tensor, np.ndarray],
    ...
    predicted_logits = predicted_logits.float()  # convert to float
    predicted_logits = predicted_logits.unsqueeze(0)
    new_shape = properties_dict['shape_after_cropping_and_before_resampling']
    predicted_logits = torch.nn.functional.interpolate(predicted_logits, new_shape, mode='trilinear')
    predicted_logits = predicted_logits.squeeze(0)
